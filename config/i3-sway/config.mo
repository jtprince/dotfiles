...
# --tb Title background.
# --tf Title foreground.
# --fb Filter background.
# --ff Filter foreground
# --nb Normal background.
# --nf Normal foreground.
# --hb Highlighted background.
# --hf Highlighted foreground.
# --sb Selected background.
# --sf Selected foreground.
# --scb Scrollbar background.
# --scf Scrollbar foreground.
bindsym $mod+Shift+P exec bemenu-run --prompt '🪄 ' --list 30 --tb="#458588CC" --tf='#EBDBB2' --fb='#282828CC' --ff="#EBDBB2" --nb='#282828CC' --nf='#EBDBB2' --hb='#458588CC' --hf='#EBDBB2' --sb='#282828CC' --sf='#50FA7B' --prefix '⫸' --ignorecase --scrollbar autohide --no-overlap --ifne --wrap
