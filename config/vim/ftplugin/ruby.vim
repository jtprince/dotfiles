...
" makes a 'do end' block
imap <S-CR>  <Esc>:.s/[ ]*$//<CR>:noh<CR>$a<Space>do<CR><CR>end<Esc>-cc
" makes a 'do || end' block
imap <C-CR>  <Esc>:.s/[ ]*$//<CR>:noh<CR>$a<Space>do<Space><bar><bar><CR>end<Esc>-$<Esc>i

" makes a {|| }
imap <C-p>  <Esc>:.s/[ ]*$//<CR>:noh<CR>$a<Space>{<bar><bar><Space>}<Esc>ssi



" CONVERTS between block structures!!
" th :B command { } --> do end
