...
parser.add_argument("gitlab_ci_file", nargs="+", help="one or more `.gitlab-ci.yml` files")
parser.add_argument("--host", default=DEFAULT_HOST, help=f"host, defaults to {DEFAULT_HOST}")
parser.add_argument("--jsonl", action='store_true', help="one line json output per file")
